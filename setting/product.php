...
$config['product']=array (
  'default_successnum' => '0',
  'default_oncemax' => '5',
  'default_imgwidth' => '125',
  'default_imgheight' => '75',
  'default_payfinder' => '10',
  'default_city' => '6',
  'default_server' => 'smtp.qq.com',
  'default_port' => '25',
  'default_user' => '809621260',
  'default_pwd' => '',
  'default_mail_from' => 'n9sky@qq.com',
  'default_mail_user' => 'Moyo',
  'default_mail_maxonce' => '5',
  'default_paytext' => 'pay',
  'default_emailcheck' => '0',
  'default_googlemapkey' => 'ABQIAAAAqwMiHfr6PCegGw-zL9_l5xTLzUt6OoGzL7cxnpgFMnbZuin2ORRLy5A2Jtdw3UJxPI7syDuzg5-qIQ',
  'default_mailtype' => '1',
  'aboutme' => '<div class="" "\'""head""\'"""="" jquery1274230576000="" "\'""22""\'"""=""><h2>关于{SYS_NAME}</h2>
</div>
<div class="" "\'""sect""\'"""="" jquery1274230576000="" "\'""23""\'"""=""><p class="" "\'""caption""\'"""="">{SYS_NAME}每天组织一次精品团购，为消费者发现最值得信赖的商家，让消费者享受超低折扣的优质服务。<br />
每天一单团购，为商家找到最合适的消费者，给商家提供最大收益的互联网推广。</p>
<dl><dt>如果您是消费者： </dt><dd><ul class="" "\'""list""\'"""=""><li>{SYS_NAME}每天帮您推荐一种优质的本地生活服务； </li>
<li>{SYS_NAME}的推荐一定物超所值； </li>
<li>{SYS_NAME}同时致力于帮您发现最好玩，最新鲜的生活方式； </li>
</ul>
</dd><dt>如果您是商家： </dt><dd><ul class="" "\'""list""\'"""=""><li>{SYS_NAME}有热爱尝试的消费者； </li>
<li>{SYS_NAME}有保证效果的广告价值； </li>
<li>{SYS_NAME}是您到达消费者的桥梁；</li>
</ul>
</dd></dl></div>',
  'privacy' => '<h4>隐私政策</h4>
<p>{SYS_NAME}非常重视对用户隐私权的保护，用户的邮件及手机号等个人资料为用户重要隐私，{SYS_NAME}承诺不会将个人资料用作它途；承诺不会在未获得用户许可的情况下擅自将用户的个人资料信息出租或出售给任何第三方，但以下情况除外：</p>
<ol class="" "\'""list""\'"""=""><li>用户同意让第三方共享资料； </li>
<li>用户同意公开其个人资料，享受为其提供的产品和服务； </li>
<li>本站需要听从法庭传票、法律命令或遵循法律程序； </li>
<li>本站发现用户违反了本站服务条款或本站其它使用规定。 </li>
</ol>
<h4>使用说明</h4>
<p>{SYS_NAME}用户可以通过设定的密码来保护账户和资料安全。用户应当对其密码的保密负全部责任。请不要和他人分享此信息。如果您使用的是公共电脑，请在离开电脑时退出{SYS_NAME}以保证您的信息不被后来的使用者获取。</p>',
  'contat' => '我们的联系电话是：#￥@#￥@#￥@#￥@#￥<br />
地址是：@#￥@￥DEREWR',
  'joinus' => '<span>招聘</span>：<br />
php程序员一名<br />',
  'terms' => '<div class="" "\'""head""\'"""="" jquery1274230028234="" "\'""22""\'"""=""><h2>用户协议</h2>
</div>
<div class="" "\'""sect""\'"""="" sizcache="" "\'""5""\'"""="" sizset="" "\'""16""\'"""="" jquery1274230028234="" "\'""23""\'"""=""><h4>一、{SYS_NAME}服务条款的确认和接纳</h4>
<h4></h4>
<p>{SYS_NAME}（以下简称本站）的各项电子服务的所有权和运作权归本站。本站提供的服务将完全按照其发布的服务条款和操作规则严格执行。用户必须完全同意所有服务条款并完成注册程序，才能成为本站的正式用户。用户确认：本协议条款是处理双方权利义务的当然约定依据，除非违反国家强制性法律，否则始终有效。在下订单的同时，您也同时承认了您拥有购买这些产品的权利能力和行为能力，并且将您对您在订单中提供的所有信息的真实性负责。</p>
<h4>二、服务简介</h4>
<p>本站运用自己的操作系统通过国际互联网络为用户提供网络服务。同时，用户必须：</p>
<p></p>
<ol class="" "\'""list""\'"""=""><li>自行配备上网的所需设备，包括个人电脑、调制解调器或其他必备上网装置。 </li>
<li>自行负担个人上网所支付的与此服务有关的电话费用、网络费用。 </li>
</ol>
<p>基于本站所提供的网络服务的重要性，用户应同意：</p>
<ol class="" "\'""list""\'"""=""><li>提供详尽、准确的个人资料。 </li>
...
<p sizcache="" "\'""5""\'"""="" sizset="" "\'""16""\'"""="">关于用户隐私的具体协议以本站的隐私声明<a href="" "\'http:="" 192.168.1.103="" "%5c%22="" groupon="" about="" privacy.php%5c%22="" "\'"""=""></a>为准。</p>
...
<ol class="" "\'""list""\'"""=""><li>停止使用本站的网络服务。 </li>
<li>通告本站停止对该用户的服务。 </li>
</ol>
