...
'idx' => array(
	'admin' => array(
        'adplay_cl_list' => 'adplay_cl_username',
		'adplay_ad_list' => 'adplay_ad_name',
		'adplay_qt_list' => 'adplay_qt_name',
		'adplay_q_list' => 'adplay_q_name',
...
'frc' => array(
	'admin' => array(
		'adplay_cl_list' => 'adplay_cl_state',
		'adplay_q_list' => 'adplay_qt',
		'order_list' => 'order_status,order_process,coupon_status',
...
'map' => array(
	'adplay_cl_username' => array(
        'name' => '申请用户',
        'table' => 'adplay_credit_log',
        'src' => 'username',
        'key' => 'id',
        'idx' => 'id'
    ),
	'adplay_ad_name' => array(
        'name' => '名称',
        'table' => 'adplay',
        'src' => 'name',
        'key' => 'id',
...
'filter' => array(
	...
	'adplay_qt' => array(
		'name' => '问题分类：',
		'key' => 'cls',
		'list' => logic('adplay')->GetList_QT_Select()
	),
	'order_status' => array(
		'name' => '订单状态',
		'key' => 'ordsta',
