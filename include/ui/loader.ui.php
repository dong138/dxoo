...
class LoaderUI {
	...
	public function __construct() {
		$this->__addon_map = array (
				...
				'editor.kind' => array (
						'css' => array (
								'@KindEditor/themes/default/default',
								'@KindEditor/themes/simple/simple' 
						),
						'js' => array (
				...
				'editor.kind4' => array (
						'css' => array (
								'@kindeditor4/themes/default/default'
						),
						'js' => array (
								'@kindeditor4/kindeditor',
								'@kindeditor4/lang/zh_CN'
						)
				),
				'uploader.swf' => array (
						'css' => array (
								'@SwfUploader/swfupload' 
						),
						'js' => array (
								'@SwfUploader/swfobject',
								'@SwfUploader/swfupload' 
						) 
				),
