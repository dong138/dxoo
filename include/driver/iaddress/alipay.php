...
class alipayImportAddressDriver extends ImportAddressDriver
{
	...
	{
		if ($_POST['receive_address'])
		{
						$_POST['receive_address'] = stripslashes($_POST['receive_address']);
		}
		$uid = $this->__Notify_Verify($this->config);
