...
$(document).ready(function(){
    ...
    loadCitys(__Default_CityID);    loadAgenters(__Default_AgenterID);
});
...
}function loadAgenters(aid){    $('#allAgenterList').html('<option value="-1">正在加载</option>');    $.get('admin.php?mod=tttuangou&code=listAgenter&id='+aid+$.rnd.stamp(), function(data){        $('#allAgenterList').html(data);    });}
